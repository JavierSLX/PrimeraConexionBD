    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnconsultar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               new ConsultarDatos().execute("http://192.168.1.124/CursoAndroid/consulta.php?id="+etId.getText().toString());
        ...
        btnGuardar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                txtmsj.setText("Hola ya");
                new CargarDatos().execute("http://192.168.1.124/CursoAndroid/registro.php?nombres="+etNombres.getText().toString()+"&tel="+etTelefono.getText().toString());
